function identificazioneCamera_cropped(percorsoRP, immaginePercorso, nomeImmagine, FID_FileCorrelazione)
%  identificazioneCamera_cropped(percorsoRP,immaginePercoso, nomeImmagine, FID_FileCorrelazione)
%
