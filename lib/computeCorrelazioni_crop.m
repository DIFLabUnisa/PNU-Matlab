function computeCorrelazioni_crop(directoryImages, ReferencePattern, stringaPattern, percorsoFileOutput, descrizione)

% computeCorrelazioni_crop(directoryImages, ReferencePattern, stringaPattern, percorsoFileOutput, descrizione)
%
