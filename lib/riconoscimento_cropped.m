function riconoscimento_cropped(directoryImages, percorsoFileOutput, percorsoRP, descrizione)

%  riconoscimento_cropped(directoryImages, percorsoFileOutput, percorsoRP, descrizione)
%
%
...
for i = 1 : length(files)
    if ~directory(i).isdir % escludo qualsiasi cartella, anche ./ ../
	    ...
	    identificazioneCamera_cropped(percorsoRP, IMG, char(files(i)), FileCorrelazione);
