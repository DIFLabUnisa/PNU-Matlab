function [Result] = esperimentoCorrelazioni2(referencePattern, percorsoImmagine, n, m, percorsoFileOutput, riga, colonna, nomeSave)
% [Result] = esperimentoCorrelazioni2(referencePattern, percorsoImmagine, n, m, percorsoFileOutput, riga, colonna, nomeSave)
