function computeReferencePattern2(pathApplicazione, numImg)

% computeReferencePattern2(pathApplicazione, numImg)
%
...
for k = 1 : length(files) 
	 if directory(k).isdir 
	   ...
	   [referencePattern]=mediaReferencePattern2(strcat(dirImgEnr, strcat(nomeDir, '/')), numImg); 
