function confronto(pathReferencePatterns, pathImages, numImg, fileOutput, classe, resize_cropped)

% confronto(pathReferencePatterns, pathImages, numImg, fileOutput, classe, resize_cropped)
%
