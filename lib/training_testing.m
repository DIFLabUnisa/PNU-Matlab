function training_testing(pathApplicazione, pathReferencePatterns, pathImmagini, resize_cropped, training_testing)

% training_testing(pathApplicazione, pathReferencePatterns, pathImmagini, resize_cropped, training_testing)
%
...
for k = 1 : length(files) 
	...
	confronto(pathReferencePatterns, pathImagesAbs, numImg, fileOutput, classe, resize_cropped);
