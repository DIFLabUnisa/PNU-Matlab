function riconoscimento(directoryImages, percorsoFileOutput, percorsoRP, descrizione)

%  riconoscimento(directoryImages, percorsoFileOutput, percorsoRP, descrizione)
%
%
...
for i = 1 : length(files)
    if ~directory(i).isdir % escludo qualsiasi cartella, anche ./ ../
	    ...
	    identificazioneCamera(percorsoRP, IMG, char(files(i)), FileCorrelazione);
