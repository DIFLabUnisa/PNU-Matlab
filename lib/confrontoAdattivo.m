function confrontoAdattivo(pathReferencePatterns, pathImages, numImg, fileOutput, classe, resize_cropped,db)

% confrontoAdattivo(pathReferencePatterns, pathImages, numImg, fileOutput, classe, resize_cropped,db)
%
...
for j=1:length(files)
	...
	[residual_noise]=getResidualNoiseAdattivo2(immagine,db); % Applicazione del filtro di denoising
